//based on https://dev.to/rohitk570/creating-a-calculator-using-java-awt-16ll
import java.awt.*;  
...
class Application extends WindowAdapter implements ActionListener{ 
	...
	Application(){  
		//intancing calculator components
		...
		//including components to the calculator
		f.add(l1);  
	...
	//main mathod which instance Application
